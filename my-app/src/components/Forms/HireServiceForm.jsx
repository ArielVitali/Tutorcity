...
const HireServiceForm = () => {
  return (
    <div className="flex justify-center">
      <div>
        <div className="flex justify-start px-4 sm:px-2 md:flex md:justify-start md:items-center">
          <h3 className="font-semibold text-gray-900">Hire the service</h3>
        </div>
        <div className="mt-6 border-t border-gray-100 md:shadow-md max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 ">
          <form action="">
